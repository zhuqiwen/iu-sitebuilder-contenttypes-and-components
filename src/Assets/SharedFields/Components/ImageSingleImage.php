...
class ImageSingleImage implements ComponentInterface{
    ...
    public function __construct(SingleImage $singleImage, string $caption = '', string $attribution = '', string $htmlId = '')
    {
        $this->type = 'single';
    ...
    public function constructComponentGroupNode(): GroupNode
    {
        ...
        $groupNode->addChild($this->singleImage->constructComponentGroupNode());
